...
Format: `add-course c/COURSE_CODE n/COURSE_NAME`

Examples:
* add-course c/CS1101S n/Programming Methodology 1
* add-course c/MA1522 n/Linear Algebra
...
**Add Course** | `add-course c/COURSE_CODE n/COURSE_NAME`<br> e.g., `add-course c/CS1101S n/Programming Methodology 1`
**List**   | `list`
**Help**   | `help`
